...
import "./styles.less";
import { Model, Table as ReactTable } from "@voomsway/react-table/dist";
...
const Main = () => {
  ...
  return (
    <Layout className="Content" style={{ marginLeft: 300, marginTop: 64 }}>
      <Content style={{ margin: "15px", overflow: "initial" }}>
